...
module.exports = function(config) {
  config.set({
    ...
    files: [
        ...
        './src/main/resources/static/js/employeeController.js',
        './src/main/resources/static/js/employeeService.js',
        
        './src/main/resources/static/jsunittest/employee.controller.test.js'
    ],
